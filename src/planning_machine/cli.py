...
def options_and_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Planning-Machine thinks for you about the meanings.",
        epilog="Example:  planning-machine input_text.txt > output_text.txt"
...
def run():
    """
    $ text | planning-machine                        # Accepts text from the pipe
    $ echo "...<text>..." | planning-machine         #

    $ planning-machine multilogue.txt new_turn.txt    # ...or files.
    """
